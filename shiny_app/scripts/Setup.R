# Setup.R
# Description:
#   Initializes the environment by installing and loading required packages and 
#   loading the unified YAML configuration.
#   This script constructs common paths used by subsequent blocks.
...
# Use the absolute root path defined in the YAML
...
# Construct common paths for later use (if needed by later blocks)
